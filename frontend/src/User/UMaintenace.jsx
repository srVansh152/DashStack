...
const UMaintenace = () => {
  ...
  return (
    ...
    <div className="flex flex-wrap justify-between items-center mb-4">
      <h2 className="text-lg md:text-xl font-medium">Pending Maintenance</h2>
      <Link to="/user/uview">
        <button className="px-4 py-2 bg-orange-600 text-white rounded-lg text-sm md:text-base">
          View Invoice
        </button>
      </Link>
    </div>
      ...
      {[1, 2, 3].map((item) => (
        <div key={item} className="bg-white rounded-lg p-4 shadow-md">
          <div className="flex justify-between items-center mb-4">
            <div className="bg-blue-500 text-white px-4 py-1 rounded text-sm md:text-base">
              Maintenance
            </div>
            <div className="bg-yellow-100 text-yellow-800 px-4 py-1 rounded text-sm md:text-base">
              Pending
            </div>
          </div>
          <div className="space-y-2 mb-4">
            <div className="flex justify-between">
              <span className="text-gray-500 text-sm md:text-base">Bill Date</span>
              <span className="text-sm md:text-base">1/01/2024</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 text-sm md:text-base">Pending Date</span>
              <span className="text-sm md:text-base">1/01/2024</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 text-sm md:text-base">Maintenance Amount</span>
              <span className="text-sm md:text-base">1000.00</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500 text-sm md:text-base">
                Maintenance Penalty Amount
              </span>
              <span className="text-sm md:text-base">250.00</span>
            </div>
            <div className="flex justify-between font-medium">
              <span className="text-sm md:text-base">Grand Total</span>
              <span className="text-green-600 text-sm md:text-base">₹ 1,250</span>
            </div>
          </div>
          <button
            onClick={handleAddModel}
            className="w-full py-2 bg-orange-600 text-white rounded-lg text-sm md:text-base"
          >
            Pay Now
          </button>
        </div>
