...
function Viewmodel() {
    ...
    const [openViewModel, setOpenViewModel] = useState(true);
    ...
    <tbody className="bg-white divide-y divide-gray-200">
      ...
      <div className="px-6 py-4 space-y-4">
        ...
        <div className="flex justify-end space-x-4 pt-4">
          ...
          <button onClick={handleViewDetails} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            Cancel
          </button>
       
          <Link to='/deletemodel'>
          <button className="px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
            Create
          </button>
          </Link>
        </div>
